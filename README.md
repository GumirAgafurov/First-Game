...
- **Frontend:** JavaScript (ES6+), HTML5 Canvas, CSS3, Touch Events API
- **Инструменты:** Webpack, Jest
- **Хранение данных:** JSON (конфигурация уровней), LocalStorage
- **Архитектура:** ООП, Модульная система
